...
var child_amount = 5; // Select amount of records to generate in child cmdb. Populates from parent for easier relation creation.               
...
function generateName() {
    ...
    this.name = capFirst(name1[getRandomInt(0, name1.length + 1)]) + ' ' + capFirst(name2[getRandomInt(0, name2.length + 1)]);
...
var ArrayHandler = Class.create();

ArrayHandler.prototype = {
    initialize: function() {
        this.array = [];
    },
    ...
    getUniqueValues: function() {
        ...
        for (var i = 0; i < this.array.length; i++) {
            if (uniqueArray.indexOf(this.array[i]) === -1) {
                uniqueArray.push(this.array[i]);
            }
        }
